...
//引入组件类
var HomeClass  = require('../Home/ZaxHome');
var  ShopClass = require('../GBShop/ZaxGBShop');
var  MyCenterClass = require('../MyCenter/ZaxMyCenter');
var  shopCarClass  = require('../ShopCar/ZaxShopCar');

var  ZaxMain = React.createClass({
        ...
        return (
            <TabNavigator>
                ...
                >
                    ...
                    <Navigator
                        initialRoute={{name:'首页',component:HomeClass}}
                        configureScene={()=>{
                ...
                >
                    ...
                    <Navigator
                        initialRoute={{name:'商家',component:ShopClass}}
                        configureScene={()=>{
                            return Navigator.SceneConfigs.PushFromRight;
                        }}
                        renderScene={(route,navigator)=>{
                ...
                >
                    ...
                    <Navigator
                        initialRoute={{name:'我的',component:shopCarClass}}
                        configureScene={()=>{
                            return Navigator.SceneConfigs.PushFromRight;
                        }}
                        renderScene={(route,navigator)=>{
                ...
                >
                    ...
                    <Navigator
                        initialRoute={{name:'更多',component:MyCenterClass}}
                        configureScene={()=>{
                            return Navigator.SceneConfigs.PushFromRight;
                        }}
                        renderScene={(route,navigator)=>{
